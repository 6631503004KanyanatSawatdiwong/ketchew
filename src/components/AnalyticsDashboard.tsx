...
export const AnalyticsDashboard: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'insights' | 'export' | 'share'>('overview');
                  ...
                  <div key={day} className="flex items-center gap-3">
                    ...
                    <div className="flex-1 bg-gray-100 dark:bg-gray-700 rounded h-4 relative">
                      <div
                        ...
                        style={{ 
                          width: `${Math.max(
                            (count / Math.max(...Object.values(insights.weekdayProductivity))) * 100,
                            count > 0 ? 10 : 0
                          )}%` 
                        }}
                      ></div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700">
              ...
              <div className="space-y-4">
                <p className="text-gray-600 dark:text-gray-400">
                  Export your productivity data for external analysis or backup purposes.
                  Current selection: <span className="font-medium">{timeRange === 'week' ? 'Last 7 days' : timeRange === 'month' ? 'Last 30 days' : 'Last year'}</span>
                </p>
