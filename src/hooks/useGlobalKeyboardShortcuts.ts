      ...
      action: () => {
        ...
        if (popupManager) {
          if (popupManager.isPopupOpen('timer')) {
            const popup = popupManager.getOpenPopups().find((p: { id: string; type: string }) => p.type === 'timer');
      ...
      action: () => {
        ...
        if (popupManager) {
          if (popupManager.isPopupOpen('tasks')) {
            const popup = popupManager.getOpenPopups().find((p: { id: string; type: string }) => p.type === 'tasks');
            if (popup) popupManager.closePopup(popup.id);
          } else {
      ...
      action: () => {
        ...
        if (popupManager) {
          if (popupManager.isPopupOpen('notes')) {
            const popup = popupManager.getOpenPopups().find((p: { id: string; type: string }) => p.type === 'notes');
            if (popup) popupManager.closePopup(popup.id);
          } else {
      ...
      action: () => {
        ...
        if (popupManager) {
          if (popupManager.isPopupOpen('analytics')) {
            const popup = popupManager.getOpenPopups().find((p: { id: string; type: string }) => p.type === 'analytics');
            if (popup) popupManager.closePopup(popup.id);
          } else {
      ...
      action: () => {
        ...
        if (popupManager) {
          if (popupManager.isPopupOpen('settings')) {
            const popup = popupManager.getOpenPopups().find((p: { id: string; type: string }) => p.type === 'settings');
            if (popup) popupManager.closePopup(popup.id);
          } else {
